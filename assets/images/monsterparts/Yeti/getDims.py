...
def main():
    ...
    parser.add_argument('folder_name',help="folder to get dimensions from")
    parser.add_argument('resize_folders',nargs="+",help="folder to set dimensions to")
    args = parser.parse_args()
    filenames = get_pngs(args.folder_name)
    ...
    for filename in filenames:
        ...
        print("file:",filename,"has width:",width,"height:",height)
        file_map[basename(filename)] = (width,height)
    print("map:",file_map)
