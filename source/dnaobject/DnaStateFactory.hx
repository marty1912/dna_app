...
else if (type == "StudentDataSave")
		{
			state = new DnaState("StudentDataSave");
			state.m_json_file = ConfigFile.text("assets/data/DnaStateArchetypes/TestStudents/StudentDataSave.json");
		}
		// INSERT_HERE
		else
		{
