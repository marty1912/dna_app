 ...
 */
class DotsCompTutorial_02 implements DnaObject implements DnaEventSubscriber extends DnaObjectBase
{
	/**
	 * overwritten ctor.
	 */
	...
	override public function onReady()
	{
		...
		dots_disp_obj.setParams({
			img_left: "assets/images/dots/id_11_dots_16.png",
			img_right: "assets/images/dots/id_0_dots_5.png",
			solution: "assets/images/dots/id_11_dots_16.png",
		});
