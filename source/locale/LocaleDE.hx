...
class LocaleDE implements Locale
{
	...
	public final translation_map:Map<String, String> = [
		...
		"StudentIntro_confirm_PC" => ConfigFile.text("assets/text/de/StudentIntro_confirm_PC.txt"), "4" => ConfigFile.text("assets/text/de/4.txt"),
		...
		"ProbCode_HEAD" => ConfigFile.text("assets/text/de/ProbCode_HEAD.txt"), "UNLOCKSTATE_HEAD" => ConfigFile.text("assets/text/de/UNLOCKSTATE_HEAD.txt"),
		...
		"IntroText_02" => ConfigFile.text("assets/text/de/IntroText_02.json"), "NewUnlock" => ConfigFile.text("assets/text/de/NewUnlock.json"),
		...
		"NumberlineTutorial_03" => ConfigFile.text("assets/text/de/NumberlineTutorial_03.json"), "0" => ConfigFile.text("assets/text/de/0.txt"),
		...
		"TEXTBOX_TEST" => ConfigFile.text("assets/text/de/TEXTBOX_TEST.txt"), "InfoState_HEAD" => ConfigFile.text("assets/text/de/InfoState_HEAD.txt"),
		"3" => ConfigFile.text("assets/text/de/3.txt"), "IntroText_03" => ConfigFile.text("assets/text/de/IntroText_03.txt"),
		...
		"ProbCode_BODY" => ConfigFile.text("assets/text/de/ProbCode_BODY.txt"), "ProbCodeText_01" => ConfigFile.text("assets/text/de/ProbCodeText_01.txt"),
		...
		"MainMenuTutorial_05" => ConfigFile.text("assets/text/de/MainMenuTutorial_05.json"), "6" => ConfigFile.text("assets/text/de/6.txt"),
		...
		"INFO_STATE_C_SOUND" => ConfigFile.text("assets/text/de/INFO_STATE_C_SOUND.txt"), "7" => ConfigFile.text("assets/text/de/7.txt"),
		"FeedbackQuestion_Nervous" => ConfigFile.text("assets/text/de/FeedbackQuestion_Nervous.txt"),
		"IntroText_01" => ConfigFile.text("assets/text/de/IntroText_01.json"), "2" => ConfigFile.text("assets/text/de/2.txt"),
		"SymbolicNumberComparison_HEAD" => ConfigFile.text("assets/text/de/SymbolicNumberComparison_HEAD.txt"),
		"ProbCodeText_03" => ConfigFile.text("assets/text/de/ProbCodeText_03.txt"), "8" => ConfigFile.text("assets/text/de/8.txt"),
		...
		"1" => ConfigFile.text("assets/text/de/1.txt"), "NumberlineFeedbackIncorrect" => ConfigFile.text("assets/text/de/NumberlineFeedbackIncorrect.json"),
		...
		"OrdTask_HEAD" => ConfigFile.text("assets/text/de/OrdTask_HEAD.txt"), "5" => ConfigFile.text("assets/text/de/5.txt"),
		...
		"test_pipe" => ConfigFile.text("assets/text/de/test_pipe.json"), "INFO_STATE_ID" => ConfigFile.text("assets/text/de/INFO_STATE_ID.txt"),
	...
	public final audio_path_map:Map<String, String> = [
		"NumberlineTutorial_02" => ("assets/sounds/de/NumberlineTutorial_02.mp3"), "MainMenuTutorial_03" => ("assets/sounds/de/MainMenuTutorial_03.mp3"),
		"NumberlinePracticeDone" => ("assets/sounds/de/NumberlinePracticeDone.mp3"), "IntroText_01" => ("assets/sounds/de/IntroText_01.mp3"),
		"IntroText_02" => ("assets/sounds/de/IntroText_02.mp3"), "MainMenuTutorial_04" => ("assets/sounds/de/MainMenuTutorial_04.mp3"),
		"MainMenuTutorial_06" => ("assets/sounds/de/MainMenuTutorial_06.mp3"), "NumberlineTutorial_01" => ("assets/sounds/de/NumberlineTutorial_01.mp3"),
		"NumberlineTaskDone" => ("assets/sounds/de/NumberlineTaskDone.mp3"),
		"NumberlineFeedbackIncorrect" => ("assets/sounds/de/NumberlineFeedbackIncorrect.mp3"),
		"NumberlineFeedbackRealTask" => ("assets/sounds/de/NumberlineFeedbackRealTask.mp3"),
		"MainMenuTutorial_02" => ("assets/sounds/de/MainMenuTutorial_02.mp3"), "MainMenuTutorial_05" => ("assets/sounds/de/MainMenuTutorial_05.mp3"),
		"MainMenuTutorial_end" => ("assets/sounds/de/MainMenuTutorial_end.mp3"), "MainMenuTutorial_01" => ("assets/sounds/de/MainMenuTutorial_01.mp3"),
		"NumberlineTutorial_04" => ("assets/sounds/de/NumberlineTutorial_04.mp3"),
		"NumberlineFeedbackCorrect" => ("assets/sounds/de/NumberlineFeedbackCorrect.mp3"),
		"NumberlineTutorial_03" => ("assets/sounds/de/NumberlineTutorial_03.mp3")];
